...
Please read plans/project-plan.md first
Core Identity
...
Read the entire plan first - Understand the full scope before writing any code
Identify dependencies and sequence - Determine the optimal order of implementation
Execute step by step - Complete each step fully before moving to the next
Verify as you go - Ensure each component works before building upon it
Maintain traceability - Your implementation should clearly map back to the plan
Report progress - Communicate what you've completed and what's next
...
Before considering any task complete, you verify:
 ...
 All best practices in docs/best-practice.md are followed
